...
sj01.addEventListener("click",function(){
		x++
		if(x%2==0){
			sj01.style.marginLeft= "+"+ 5 +"px";
			sj02.style.marginLeft= "+"+ 5 +"px";
			sj03.style.marginLeft= "+"+ 5 +"px";
			sj04.style.marginLeft= "+"+ 5 +"px";
			sj01img.className = "sj01img";
			sj02img.className = "sj02img";
			sj03img.className = "sj03img";
			sj04img.className = "sj04img";
		}else{
		  sj02.style.marginLeft= "+"+ 700 +"px";
		  sj03.style.marginLeft= "+"+ 5 +"px";
		  sj04.style.marginLeft= "+"+ 5 +"px";
		  sj01img.className = "sj01imgl";
		  sj02img.className = "sj02img";
		  sj03img.className = "sj03img";
		  sj04img.className = "sj04imgl";
		}	
	});
	
	sj02.addEventListener("click",function(){
		y++
		if(y%2==0){
			sj01.style.marginLeft= "+"+ 5 +"px";
			sj02.style.marginLeft= "+"+ 5 +"px";
		  ...
		  sj02.style.marginLeft= "+"+ 5 +"px";
		  sj03.style.marginLeft= "+"+ 700 +"px";
		  sj04.style.marginLeft= "+"+ 5 +"px";
			sj02img.className = "sj02imgl";
			sj01img.className = "sj01img";
			sj03img.className = "sj03img";
			sj04img.className = "sj04imgl";
		}	
	...
	sj03.addEventListener("click",function(){
		z++
		if(z%2==0){
			sj01.style.marginLeft= "+"+ 5 +"px";
			sj02.style.marginLeft= "+"+ 5 +"px";
		  ...
		  sj02.style.marginLeft= "+"+ 5 +"px";
		  sj03.style.marginLeft= "+"+ 5 +"px";
		  sj04.style.marginLeft= "+"+ 700 +"px";
			sj03img.className = "sj03imgl";
			sj01img.className = "sj01img";
			sj02img.className = "sj02img";
			sj04img.className = "sj04imgl";
		}	
